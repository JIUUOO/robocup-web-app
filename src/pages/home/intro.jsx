      ...
      <Accordion>
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body className="text-start">
            ...
            <p className="fs-6 d-block">
              ...
              자원봉사자들로 구성된 비영리 기관입니다.
            </p>
            <p className="fs-6 d-block">
              &nbsp;RCKA는 도전, 협동 및 경쟁 촉면 등 교육에 필요한 여러가지를
              모두 제공합니다.
            </p>
            <p className="fs-6 d-block">
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body className="text-start">
            ...
            <p className="fs-6 d-block">
              &nbsp;청소년 학생들의 경우 로보컵 리그를 통하여 여러
              로봇분야-전자, 하드웨어, 소프트웨어 등-에 대한 기술능력을 직접
              키울 수 있는 기회를 제공합니다.
            </p>
            <p className="fs-6 d-block">
              아울러 친구들과 함께 기술을 공유하면서 팀워크에 대해 배울 수 있는
              동기부여를 받고 특별한 경험을 할 수 있는 새로운 방법을 제시합니다.
            </p>
            <p className="fs-6 d-block">
              로보컵 리그는 다양한 참가자들이 우수한 로봇개발이라는 공동의
              목표를 달성할 수 있는 팀으로 함께 연구할 수 있는 기회를
              제공합니다.
            </p>
          </Accordion.Body>
        </Accordion.Item>
